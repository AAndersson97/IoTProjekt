...
public class TopologyTuple {
    ...
    public final float t_time; // specificerar tiden då tupeln går ut och måste tas bort

    public TopologyTuple(short[] t_dest_addr, short[] t_last_addr, int t_seq, float vTime) {
        this.t_dest_addr = t_dest_addr;
        this.t_last_addr = t_last_addr;
        this.t_seq = t_seq;
        this.t_time = System.currentTimeMillis() + (vTime * 1000);
    }
}
