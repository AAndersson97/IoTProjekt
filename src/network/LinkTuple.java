...
public class LinkTuple {
    ...
    public float l_time; // tiden då tuppeln blir ogiltig
    ...
    public LinkTuple(short[] l_local_iface_addr, short[] l_neighbor_iface_addr, float l_sym_time, float l_asym_time) {
        ...
        this.l_time = System.currentTimeMillis() + LINK_HOLD_TIME;
    }
